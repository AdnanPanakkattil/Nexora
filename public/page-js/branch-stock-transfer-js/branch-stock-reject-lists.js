$(document).ready(function () {
    ...
    $("#branch_stoke_reject_sub_menu").addClass("active");
    ...
    var branchStockTransferTable = $("#branch_stock_transfer_table").DataTable({
        ...
        serverSide: true,
        ajax: {
            url: BASE_URL + "/branchstocktransfer/branch-stock-reject-lists", // URL for the server-side processing
            data: function (d) {
        ...
        columns: [
            { data: "stockRejectId", name: "stockRejectId" },

            { data: "stockRejectNo", name: "stockRejectNo" },
    ...
    $("#stockRejectSearchBtn").on("click", function () {
