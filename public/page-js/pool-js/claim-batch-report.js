        ...
        columns: [
            ...
            { data: "status", name: "status" },
            {
                ...
                render: function (data, type, full, meta) {
                    var viewUrl = BASE_URL + "/view-batch-details/" + full.claimId;
                    ...
                    return (
                        ...
                        '<li>' +
                        '<a href="javascript:;" class="dropdown-item edit-batch" data-id="' + full.claimId + '">Edit</a>' +
                        '</li>' +
                        '<div class="dropdown-divider"></div>' +
                        '<li>' +
                        '<a href="' + viewUrl + '" class="dropdown-item" data-id="' + full.claimId + '">View</a>' +
                        '</li>' +
                        '<div class="dropdown-divider"></div>' +
                        '<li>' +
                        '<a href="javascript:;" class="dropdown-item text-danger delete-batch" data-id="'   + full.claimId + '">Delete</a>' +
                        '</li>' +
                        '</ul>' +
                        '</div>'
                    );
