$(document).ready(function() {
    ...
    if (dt_user_table.length) {
        var dt_user = dt_user_table.DataTable({
          ...
          buttons: [
            ...
            {
              text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Employee Registration 1212</span>',
  ...
  $('#DataTables_Table_0 tbody').on('click', '.custom-check1', function() {
