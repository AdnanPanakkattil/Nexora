$(document).ready(function () {
    ...
    $("#purchase_vat_report_sub_menu").addClass("active");
    ...
    if (rangePickr.length) {
        rangePickr.flatpickr({
            ...
            onClose: function (selectedDates, dateStr, instance) {
                ...
                purchaseReportTable.ajax.reload();
            },
        });
    }

    var purchaseReportTable = $("#purchase_report_table").DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: BASE_URL + "/purchase/vat-report-data",
            data: function (d) {
        ...
        columns: [
            ...
            { data: "vendor_code", className: "text-center" },
            { data: "vendor_vat", className: "text-center" },
            ...
            // { data: "invoice_no", className: "text-center" },
            {
                ...
                render: function (data, type, full, meta) {
                    var detailsUrl =
                        ...
                        full.purchaseItemBillId;
                    return (
                        '<a href="' +
                        detailsUrl +
                        '" target="_blank" class="btn btn-outline-primary waves-effect " style="width:100%;" ><i class="ti ti-report-medical"></i>' +
                        full.invoice_no +
                        "</a>"
                    );
                },
            ...
            { data: "bonus_vat", className: "text-center" },
