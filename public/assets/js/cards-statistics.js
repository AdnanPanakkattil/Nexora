...
(function () {
  ...
  const salesLastYearEl = document.querySelector('#salesLastYear'),
    salesLastYearConfig = {
      ...
      series: [
        {
           data: isRtl ? [200, 55, 400, 250].reverse() : [200, 55, 400, 250]
        }
      ],
      xaxis: {
        show: true,
  ...
  const subscriberGainedEl = document.querySelector('#subscriberGained'),
    subscriberGainedConfig = {
      ...
      series: [
        {
           data: isRtl ? [200, 60, 300, 140, 230, 120, 400].reverse() : [200, 60, 300, 140, 230, 120, 400] 
        }
      ],
      xaxis: {
        show: true,
  ...
  const infoGainedEl = document.querySelector('#infoGained'),
  infoGainedConfig = {
    chart: {
      height: 90,
      type: 'area',
    ...
    colors: ['#00bad1'], // Updated to the desired color
    fill: {
      type: 'gradient',
      gradient: {
        shade: shadeColor,
...
if (typeof infoGainedEl !== undefined && infoGainedEl !== null) {
  const infoGained = new ApexCharts(infoGainedEl, infoGainedConfig);
  infoGained.render();
}
