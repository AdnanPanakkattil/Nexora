                                ...
                                <div class="card invoice-preview-card p-sm-12 p-6">
                                    <div class="d-flex align-items-center justify-content-between mt-8 mb-8">
                                        <div class="d-flex align-items-center flex-column">
                                            <h4 class="m-0 primarycol">Labe items</h4>
                                        </div>
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-4 mb-3">
                                            <label for="batchModeSelect" class="form-label labez">Batch Mode</label>
                                            <select name="batch_mode" id="batch_mode" class="selectpicker w-100" data-style="btn-default">
                                                <option value="purchase_based">Purchase Based</option>
                                                <option value="batch_group">Batch Group</option>
                                            </select>
                                        </div>
                                    </div>
